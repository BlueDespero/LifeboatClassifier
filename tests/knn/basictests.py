from category_encoders import LeaveOneOutEncoder, MEstimateEncoder, BaseNEncoder
...
train_x, train_y, test, _ = get_data(["../../data/train.csv", "../../data/test.csv"], encoder=BaseNEncoder)
# train_x, train_y, test, _ = get_data(["../../data/train_num.csv", "../../data/test_num.csv"])

knn = KNN()
knn.train(train_x, train_y, k=7, distance="matching")
